...
export function ReadingStatusSelect({ value, onChangeOption, variant }: Props) {
  const status = [
    { id: 0, label: ReadingStatus.TO_READ },
    { id: 1, label: ReadingStatus.READING },
    { id: 2, label: ReadingStatus.FINISHED },
    { id: 3, label: ReadingStatus.REREADING },
    { id: 4, label: ReadingStatus.ABANDONED },
  ];
