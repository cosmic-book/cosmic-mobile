      ...
      <View className="flex-1 bg-white">
        ...
        <View className="flex-row justify-around w-full mt-4 p-4 border_y">
          <TouchableOpacity className="items-center w-1/3">
            <Text className="text-primary text-lg font-bold">{userReadingsInfo.totalItems}</Text>
            <Text className="text-gray-500">Livros</Text>
          </TouchableOpacity>
          <TouchableOpacity className="items-center w-1/3">
            <Text className="text-purple text-lg font-bold">{userReadingsInfo.totalReadPages}</Text>
            <Text className="text-gray-500">Páginas Lidas</Text>
          </TouchableOpacity>
          <TouchableOpacity className="items-center w-1/3">
            <Text className="text-pink text-lg font-bold">{userReadingsInfo.totalReviews}</Text>
