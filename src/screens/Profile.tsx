...
type ProfileProps = {
  navigation: NavigationProp<TMainStackParamList, 'Profile'>
  route: RouteProp<any>
}
      ...
      <View className="items-center mt-24">
        <TouchableOpacity onPress={handlePress}>
          <Avatar className="w-24 h-24">
            <AvatarImage source={actualUser.image ? { uri: actualUser.image } : require('../assets/user-icon.png')} />
          </Avatar>
      ...
      <ScrollView className="flex-1 w-full">
        ...
        <View className="px-12 border_y">
          <View className="flex-row items-center gap-2 my-3">
            ...
            <Text className="text-lg color-primary font-bold">Meta de Leitura</Text>
          </View>
          <View className="mb-6">
        ...
        <View className="px-12">
          <View className="flex-row items-center gap-2 my-3">
            ...
            <Text className="text-lg color-primary font-bold">Última Atividade</Text>
          </View>
